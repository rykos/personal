...
export const SkillsSegment = () => {
    ...
    let bs: string[] = ["C#", "ASP.NET", ".Net", "EF Core", "PostgreSQL", "SQLite", "REST"]
    let fs: string[] = ["React", "Angular", "HTML&CSS", "SCSS", "TS&JS", "Tailwind", "Bootstrap"];
    ...
    return (
        <div ref={ref} className="segment relative flex flex-grow justify-center items-center pt-52">
            <div>
                {/* Tilted stripe */}
